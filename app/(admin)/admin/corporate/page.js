  ...
  return (
    <Box className="space-y-6">
      <Box className="flex items-center gap-3 bg-indigo-50 rounded-xl px-5 py-4">
        ...
        <Box>
          <Text as="h1" className="text-xl font-bold text-slate-800 leading-tight">Corporate Accounts</Text>
          <Text as="p" className="text-slate-400 text-xs mt-0.5">
            Admin &rsaquo; <Text as="span" className="text-slate-500 font-medium">Corporate</Text>
          </Text>
        </Box>
      </Box>
      <CorporateAccounts />
