...
export const learnerNav = {
  ...
  learning: [
    { title: "My Trainings", icon: BookOpen, href: "/my-courses" },
  ...
  support: [
    { title: "Tickets", icon: HeadphonesIcon, href: "/tickets" },
  ],
  footer: [
...
export const trainerNav = {
  ...
  footer: [
    { title: "My Profile", icon: User,    href: "/trainer/profile" },
    { title: "Logout",     icon: LogOut,  href: "/logout" },
  ],
};
...
export const adminNav = {
  ...
  content: [
    { title: "Course Catalog", icon: Library, href: "/admin/course-catalog" },
    { title: "Trainings", icon: BookOpen, href: "/admin/courses" },
